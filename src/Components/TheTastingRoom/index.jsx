// import './TheTastingRoom.css';

function TheTastingRoom() {
	return (
		<section id="menu" className="menu section-bg">
			<div className="container" data-aos="fade-up">
				<div className="section-title">
					<h2>Menu</h2>
					<p>The Tasting Room</p>
					<span>
						Serving 20 taps of exceptional craft beer, fine drinking
				...
				>
					<div className="col-lg-6 menu-item filter-starters">
						<img
							src="assets/img/menu/beer.jpeg"
							className="menu-img"
							alt=""
						/>
						<div className="menu-content">
							<a href="#/">Special Beer</a>
							<span>$15.95</span>
						</div>
						<div className="menu-ingredients">
							Lorem, trataro, filede
						</div>
					</div>
					<div className="col-lg-6 menu-item filter-starters">
						<img
